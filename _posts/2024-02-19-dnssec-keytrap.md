...
If you'd like to deploy your own DNS and DHCP servers, [arstechnica.com](https://arstechnica.com) published an interesting step-by-step [article](https://bitag.org/broadband_technologies.php) on how to deploy these key services in a home network.
